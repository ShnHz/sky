<template>
  <div class="rocker-launch">
    ...
    <svg style="display: none;" xmlns="http://www.w3.org/2000/svg">
      <symbol id="svgRocket" viewBox="0 0 24 36" xmlns="http://www.w3.org/2000/svg">
        <path
        ...
        <path
          ...
          fill="var(--rocket-line)" fill-opacity="0.3" />
      </symbol>
    </svg>
  </div>
</template>
...
export default {
  ...
  methods: {
    handleClick: lodash.debounce(function (e) {
